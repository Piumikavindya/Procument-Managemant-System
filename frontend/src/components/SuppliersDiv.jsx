...
function SuppliersDiv() {
  return (
    <div className="px-4 lg:px-14 max-w-screen-2xl mx-auto bg-NeutralSilver py-16" id="vendors">
      <div className="flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="md:w-3/4 mx-auto">
          <div>
            ...
            <p className="text-base text-NeutralGrey mb-8 font-bold">Faculty of Engineering University of Ruhuna</p>
            <div>
      ...
      <a href="/viewVendors" className="font-bold text-brandPrimary hover:text-neutral-700 no-underline">See all Suppliers{""}
