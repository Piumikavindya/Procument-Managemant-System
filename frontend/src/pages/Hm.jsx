...
export default function Hm() {
  ...
  return (
    <div className={`App ${isActive ? 'sidebar-collapsed' : ''}`}>
    ...
    <section id="content" className={isActive ? 'collapsed' : ''}>
     
      <nav>
      <i className={`bx bx-menu ${isActive ? 'active' : ''}`} onClick={() => setActive(!isActive)}></i>
