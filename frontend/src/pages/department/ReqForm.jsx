    ...
    <form>
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          <div className="rounded-md bg-gray-200 px-4 py-2 mb-6">
            <h2 className="text-lg font-semibold leading-7 text-black-900">
              Generate Request ID
            </h2>
          </div>
          ...
          <table class="min-w-full bg-white shadow-md rounded-xl">
            <thead>
              <tr class="bg-blue-gray-100 text-gray-700">
                <th class="py-3 px-4 text-left">Req ID</th>
                <th class="py-3 px-4 text-left">Item Id</th>
                <th class="py-3 px-4 text-left">Item Name</th>
                <th class="py-3 px-4 text-left">Cost</th>
                <th class="py-3 px-4 text-left">Qty Required</th>
                <th class="py-3 px-4 text-left">Qty Avaialble</th>
              </tr>
            </thead>
