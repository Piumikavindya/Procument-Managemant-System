...
<Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={handleOutsideClick}>
        <Transition.Child
          as={Fragment}
            ...
            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
              ...
              <DialogBody divider className="grid place-items-center">
                ...
                <Typography className="text-center font-normal" color="red">
                  <h6>
                    Note : Once you delete this project all details of the project will be permanently
