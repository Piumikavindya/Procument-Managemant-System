...
const { generateProjectId,createProject,addRequestsData,viewAddedRequests,viewAllProjects,deleteProject,viewProjectById, createPdf, viewShippingMethodPdf} = require('../controllers/procProject');
